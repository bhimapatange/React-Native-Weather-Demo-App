Arguments: 
  /Users/kimxogus/.nvm/versions/node/v8.9.3/bin/node /usr/local/Cellar/yarn/1.5.1_1/libexec/bin/yarn.js lerna-publish --since 3.0.0-rc.2

PATH: 
  /usr/local/opt/redis@3.2/bin:/usr/local/opt/python@2/bin:/usr/local/sbin:/Users/kimxogus/bin:/Users/kimxogus/.nvm/versions/node/v8.9.3/bin:/usr/local/opt/postgresql@9.6/bin:/usr/local/opt/thrift@0.9/bin:/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin
...
Lockfile: 
  ...
  "errno@>=0.1.1 <0.2.0-0", errno@~0.1.7:
    version "0.1.7"
  ...
  lodash@^4.14.0, lodash@^4.16.6, lodash@^4.3.0:
    version "4.17.5"
  ...
  "semver@2 || 3 || 4 || 5", semver@5.x, semver@^5.0.1, semver@^5.0.3, semver@^5.1.0, semver@^5.3.0, semver@^5.5.0:
    version "5.5.0"
...
Trace: 
  Error: Command "lerna-publish" not found.
